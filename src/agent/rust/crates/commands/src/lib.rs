...
fn render_agents_usage(unexpected: Option<&str>) -> String {
    let mut lines = vec![
        ...
        "  Sources          .alou/agents, ~/.alou/agents, $CLAW_CONFIG_HOME/agents".to_string(),
    ];
...
fn render_agents_usage_json(unexpected: Option<&str>) -> Value {
    json!({
        ...
        "usage": {
            ...
            "sources": [".alou/agents", "~/.alou/agents", "$CLAW_CONFIG_HOME/agents"],
        },
...
fn render_skills_usage(unexpected: Option<&str>) -> String {
    let mut lines = vec![
        ...
        "  Install root     $CLAW_CONFIG_HOME/skills or ~/.alou/skills".to_string(),
...
fn render_skills_usage_json(unexpected: Option<&str>) -> Value {
    json!({
        ...
        "usage": {
            ...
            "install_root": "$CLAW_CONFIG_HOME/skills or ~/.alou/skills",
            "sources": [
                ".alou/skills",
                ".omc/skills",
                ".agents/skills",
...
mod tests {
    ...
    fn agents_and_skills_usage_support_help_and_unexpected_args() {
        ...
        assert!(agents_help
            .contains("Sources          .alou/agents, ~/.alou/agents, $CLAW_CONFIG_HOME/agents"));
        ...
        assert!(skills_help.contains("Install root     $CLAW_CONFIG_HOME/skills or ~/.alou/skills"));
