...
const OFFICIAL_REPO_URL: &str = "https://github.com/ultraworkers/alou-code";
...
fn format_polymarket_orderbook_result(icon: &str, parsed: &serde_json::Value) -> String {
    ...
    let rendered_output = serde_json::to_string_pretty(parsed).unwrap_or_else(|_| parsed.to_string());
